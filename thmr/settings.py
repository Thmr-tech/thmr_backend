"""
Django settings for thmr project.
...
ALLOWED_HOSTS = ['thmr.pythonanywhere.com', '127.0.0.1']
...
AUTH_USER_MODEL = "thmr_api.CustomUser"

ROOT_URLCONF = 'thmr.urls'
...
WSGI_APPLICATION = 'thmr.wsgi.application'
...
EMAIL_PORT = getKey("EMAIL_PORT", '')
EMAIL_USE_TLS = getKey("EMAIL_USE_TLS", '')
